...
- `docs/images/breakout_dueling_smoke_curve.svg`: matplotlib-generated reward curve from the smoke run.
...
All SVG figures in `docs/images/` are generated by scripts, not manually drawn assets. The Breakout reward curve is generated with Python `matplotlib`.
